              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://linkedin.com/in/nicholasconnelly" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gold-600 transition-colors">
                      linkedin.com/in/nicholasconnelly
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://instagram.com/nickconnelly10" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gold-600 transition-colors">
                      @nickconnelly10
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Substack</p>
                    <a href="https://nicholasconnelly.substack.com" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gold-600 transition-colors">
                      nicholasconnelly.substack.com
                    </a>
                  </div>
                </div>
              </div>
